    ...
    <div style="max-width: 900px; margin: 0 auto; background: #ffffff; border-radius: 16px; box-shadow: 0 20px 50px rgba(0,0,0,0.15); overflow: hidden; position: relative;">
        ...
        <?php if(!empty($article['image'])): ?>
            <div style="width: 100%; height: 450px; position: relative;">
                <img src="<?= htmlspecialchars($article['image']) ?>" alt="<?= htmlspecialchars($article['title']) ?>" style="width: 100%; height: 100%; object-fit: cover; display: block;">
        ...
        <div style="padding: 50px 8%; position: relative;">
            <a href="news" style="color: #ef4444; text-decoration: none; font-family: 'Inter', sans-serif; font-weight: 600; font-size: 0.95rem; margin-bottom: 25px; display: inline-flex; align-items: center; gap: 8px; transition: transform 0.2s;"><i class="fa-solid fa-arrow-left"></i> Back to News</a>
